...
Loader.prototype.loadDependency = function(name) {
  ...
  return this.loadComponent(fullname, name)
}
...
Loader.prototype.implicitPaths = function() {
  this._lookup.add(this.path('components'))
  this._lookup.add(this.path('node_modules'))
  return this
}
